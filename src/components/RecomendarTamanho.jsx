...
const MARCACOES_MANEQUIM = {
  busto: (
    <g id="chest" className="group-NORMAL" key="busto" transform="translate(20, -410)">
  ...
  cintura: (
    <g id="waist" className="group-NORMAL" key="cintura" transform="translate(20, -410)">
  ...
  quadril: (
    <g id="hip" className="group-NORMAL" key="quadril" transform="translate(20, -350)">
